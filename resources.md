...
- [Demos](/demos)
    - [Data-Driven PPC with Gradio (Hugging Face)](https://huggingface.co/spaces/mansurarief/data_driven_ppc)
    - [Data-Driven Scheduling with Gradio (Hugging Face)](https://huggingface.co/spaces/mansurarief/data_driven_scheduling)
    - [Data-Driven SCP with Gradio (Hugging Face)](https://huggingface.co/spaces/mansurarief/data_driven_scp)
